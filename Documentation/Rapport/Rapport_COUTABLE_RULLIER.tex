...
que le joueur ayant le plus de points a gagné.
	...
	%IMPORTANT : justifier chaque choix effectué
...
s'agit de la trame d'acquittement elle même).
	...
	%parler des structures transmises et de l’acquittement de chaque envoi
...
endroit sur la carte). Ces différents bugs, ne se réalisaient pas à chaque fois, c'est à force de tester l'application que nous les avons détectés.
	%lorsque le deuxième joueur mourrait, seul un des deux joueurs était réinitialisé. et aussi si le trésor était trouvé, à la prochaine partie, il s'affichait
%	en (-1, -1)
